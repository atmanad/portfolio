...
export default class skills extends Component {
  render() {
    return (
      <div className="section-margin-padding" id="projects">
        <div className="container">
          <p className="h2 text-center text-e0e0e0 pb-54">Projects</p>
          <div className="row">
          ...
          <div className="row">
            <div className="col-md-5 mt-3 mb-3 mb-md-0 mx-auto">
              <MDBContainer>
                <MDBCarousel
                  activeItem={1}
                  length={3}
